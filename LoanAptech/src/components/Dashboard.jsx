...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch current user
      const userResponse = await fetch("https://loanaptech-9b30.onrender.com/api/auth/me", {
        credentials: "include"
      });
      ...
      const statsResponse = await fetch("https://loanaptech-9b30.onrender.com/api/loans/dashboard/stats", {
        credentials: "include"
      });
      ...
      const loansResponse = await fetch("https://loanaptech-9b30.onrender.com/api/loans/my-loans", {
        credentials: "include"
      });
  ...
  const handleLogout = async () => {
    try {
      await fetch("https://loanaptech-9b30.onrender.com/api/auth/logout", {
        method: "POST",
        credentials: "include"
      });
